...
requireText(rootLayout, "@/styles/flux-v12-rebuild.css", "Current global Flux redesign stylesheet");
requireText(rootLayout, 'data-flux-ui="x5"', "Current Flux UI release marker");
