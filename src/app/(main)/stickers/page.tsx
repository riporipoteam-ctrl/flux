...
export default function StickersPage() {
  ...
  return (
    <XPage>
      <XHeader title="Sticker Lab" subtitle="Publish and discover Flux stickers" icon={Sticker} hideOnMobile />

      <section className="x-hero">
        <p className="mb-3 text-[11px] font-black uppercase tracking-[0.16em] text-[var(--v8-accent)]">Creator tools</p>
        <h1>Stickers that travel with you.</h1>
        <p>Basic and Premium creators publish PNG, WebP and animated GIF stickers. Everyone can use the public library across posts, Stories and chats.</p>
        <div className="mt-5 inline-flex items-center gap-2 rounded-full border border-[var(--v8-line)] bg-[var(--v8-panel)] px-4 py-2 text-sm font-black capitalize">
          <Sparkles className="h-4 w-4 text-[var(--v8-accent)]" />
          {plan} · {plan === "premium" ? "up to 100 stickers" : plan === "basic" ? "up to 25 stickers" : "upgrade to create"}
        </div>
      </section>

      <div className="mx-auto grid w-full gap-5 px-3 py-6 sm:px-5 sm:py-9 ">
        <aside>
