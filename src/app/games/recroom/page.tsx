...
export const metadata: Metadata = {
  ...
  description: "Launch the Aug 25, 2021 Rec Room client in a private RipoTeamServer game runtime and stream it into Flux.",
};
  ...
  return (
    <>
      ...
      <Link
        ...
        title="RipoTeam owner: recover the Aug 2021 server client"
      >
