...
function sectionLabel(pathname: string): string {
  ...
  if (pathname.startsWith("/games")) return "Flux Plays";
      ...
      <header className="sticky top-0 z-50 shrink-0 border-b border-border/70 bg-card/88 pt-[env(safe-area-inset-top)] shadow-[0_8px_30px_rgba(34,32,74,.06)] backdrop-blur-2xl lg:hidden">
        <div className="flex h-14 items-center gap-2 px-3">
          <button
            ...
            className="grid h-11 w-11 shrink-0 place-items-center rounded-2xl border border-border/70 bg-muted/45 transition hover:bg-muted active:scale-95"
          ...
          <div className="flex min-w-0 flex-1 items-center gap-2 px-1 py-1">
            ...
            <div className="min-w-0 leading-tight">
              <p className="truncate text-[15px] font-black tracking-[-0.03em]">Flux <span className="text-gradient-brand">2.0</span></p>
          ...
          <Link
            ...
            className="grid h-11 w-11 shrink-0 place-items-center rounded-full transition hover:bg-muted active:scale-95"
