...
export function MobileAppHeader() {
  ...
  return (
    <>
      <header className="sticky top-0 z-50 shrink-0 border-b border-border/80 bg-card/95 pt-[env(safe-area-inset-top)] shadow-[0_1px_0_rgba(15,20,25,0.04)] backdrop-blur-2xl lg:hidden">
        <div className="flex h-14 items-center gap-2 px-3">
          ...
          <div className="flex min-w-0 flex-1 items-center gap-2 px-1 py-1">
            ...
            <div className="min-w-0 leading-tight">
              <p className="truncate text-[15px] font-extrabold tracking-tight">Flux</p>
